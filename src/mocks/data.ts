...
export const MOCK_CACTI: CactusListItem[] = [
  ...
  { id: 4, name: 'Cactus 4',    categoryName: 'Flowering', basePrice: 18.50, hasAuction: true,  description: 'Astrophytum (star cactus/bishops cap) is a genus of small, slow-growing, typically solitary, and often spineless cacti native to Mexico and the US. Known for their spherical or star-shaped bodies (3-10 ribs).', thumbnailUrl: '/Images/Cactus_4/veri1.jpg' },
